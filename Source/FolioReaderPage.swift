...
open class FolioReaderPage: UICollectionViewCell, UIWebViewDelegate, UIGestureRecognizerDelegate {
    ...
    public override init(frame: CGRect) {
        ...
        let temporaryReaderContainer = FolioReaderContainer(withConfig: FolioReaderConfig(), folioReader: FolioReader(), epubPath: "")
        self.readerContainer = temporaryReaderContainer

...
open class FolioReaderConfig: NSObject {
    ...
    open var realmConfiguration         = Realm.Configuration(fileURL: FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first, schemaVersion: 2)
